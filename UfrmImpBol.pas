...
procedure TfrmImpBol.Label79Click(Sender: TObject);
begin
...
procedure TfrmImpBol.GravarIniComponente;
var
...
procedure TfrmImpBol.LerIniComponente(const ADialog : Boolean);
var xArquivo : String;
  IniFile: TMemIniFile;
begin
  if ADialog then
...
procedure TfrmImpBol.AplicarConfiguracoesAoComponente;
...
procedure TfrmImpBol.AplicarConfiguracoesComponenteATela;
var Beneficiario : TACBrCedente;
    BeneficiarioWS : TACBrCedenteWS;
    Banco : TACBrBanco;
    Boleto : TACBrBoleto;
...
procedure TfrmImpBol.AplicarConfiguracoesComponenteEmail;
var
  Mail: TACBrMail;
begin
  Mail := FACBrMail;
...
procedure TfrmImpBol.AplicarConfiguracoesEmailNaTela(IniConfig: TMemIniFile);
begin
...
procedure TfrmImpBol.btnLerRetornoClick(Sender: TObject);
...
procedure TfrmImpBol.btnImpressaoHTMLClick(Sender: TObject);
begin
...
procedure TfrmImpBol.btnImpressaoPDFClick(Sender: TObject);
begin
  if not Assigned(FACBrBoleto.ACBrBoletoFC) then
    raise Exception.Create(MOTOR_NAO_SELECIONADO);
...
procedure TfrmImpBol.btnBoletoIndividualClick(Sender: TObject);
var
  Titulo : TACBrTitulo;
...
procedure TfrmImpBol.Button5Click(Sender: TObject);
var
  Titulo: TACBrTitulo;
  I: Integer;
  NrTitulos: String;
...
procedure TfrmImpBol.btnGerarRemessaClick(Sender: TObject);
...
procedure TfrmImpBol.btnImpressaoSpoolerClick(Sender: TObject);
var
  i: Integer;
begin
  if not Assigned(FACBrBoleto.ACBrBoletoFC) then
...
//   begin
//     FACBrBoleto.ListadeBoletos[i].Imprimir();
//
//   end;
end;

procedure TfrmImpBol.FormCreate(Sender: TObject);
var
  I: TACBrBolLayOut;
...
procedure TfrmImpBol.carregarBancos;
var
...
procedure TfrmImpBol.CarregarCaracteristicaTitulo;
var
...
procedure TfrmImpBol.CarregarResponsavelEmissao;
var
...
procedure TfrmImpBol.CarregarSSLLib;
var
  SSLLib: TSSLHttpLib;
begin
...
procedure TfrmImpBol.CarregarTipoCarteira;
var
...
procedure TfrmImpBol.CarregarTipoDistribuicao;
var
...
procedure TfrmImpBol.CarregarTipoDocumento;
var
...
procedure TfrmImpBol.Button3Click(Sender: TObject);
begin
  FACBrBoleto.ListadeBoletos.Clear;
end;

procedure TfrmImpBol.cbxLayOutChange(Sender: TObject);
begin
...
procedure TfrmImpBol.chkMostrarSenhaClick(Sender: TObject);
begin
...
procedure TfrmImpBol.btnEnviarEmailClick(Sender: TObject);
var
  SL: TStringList;
  //i: Integer;
begin
...
procedure TfrmImpBol.btnWSConsultaClick(Sender: TObject);
var
...
procedure TfrmImpBol.btnWSRegistrarClick(Sender: TObject);
var
...
procedure TfrmImpBol.btnConfigLerClick(Sender: TObject);
begin
  LerIniComponente(True);
  AplicarConfiguracoesComponenteATela;
end;

procedure TfrmImpBol.btnConfigGravarClick(Sender: TObject);
...
procedure TfrmImpBol.btnImpressaoPDFIndividualClick(Sender: TObject);
var Index : Cardinal;
begin
  if not Assigned(FACBrBoleto.ACBrBoletoFC) then
    raise Exception.Create(MOTOR_NAO_SELECIONADO);
...
procedure TfrmImpBol.btnImpressaoStreamClick(Sender: TObject);
...
procedure TfrmImpBol.btnImprimirTesteClick(Sender: TObject);
var
  LNrTitulos : Cardinal;
  LValor : Currency;
  I : Integer;
...
procedure TfrmImpBol.btnRetornoClick(Sender: TObject);
begin
  if dlgFile.Execute then
    edtPathRetorno.Text := dlgFile.FileName;
end;

procedure TfrmImpBol.Button1Click(Sender: TObject);
begin
  if dlgSave.Execute then
    edtPathLog.Text := PathWithDelim(ExtractFilePath(dlgSave.FileName));
end;

procedure TfrmImpBol.cbxMotorRelatorioChange(Sender: TObject);
var
...
procedure TfrmImpBol.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  FACBrBoleto.Free;
end;
